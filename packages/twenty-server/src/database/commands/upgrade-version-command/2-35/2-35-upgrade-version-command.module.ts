...
import { AddGenderedCreateNewRecordCommandMenuItemsCommand } from 'src/database/commands/upgrade-version-command/2-35/2-35-workspace-command-1789556201000-add-gendered-create-new-record-command-menu-items.command';
...
@Module({
  ...
  providers: [
    AddGenderedCreateNewRecordCommandMenuItemsCommand,
