...
- **Atualizar evento:** ação fixa sobre a Oportunidade e aba `Evento GSH` no registro. O formulário abre a seção pertinente à etapa e salva os dados nos objetos corretos.
...
- **Evento:** briefing, público confirmado, checklist de montagem/deslocamento/abastecimento/equipe, execução e feedback.
