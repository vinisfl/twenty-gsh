...
**Atualizar evento**:
A ação de edição livre e completa do processo (Opportunity + Execução do evento + Proposta + OS + Empresa), existente antes desta iniciativa e distinta dos modais dedicados de criação/gate de etapa — cobre qualquer edição fora do momento de criar ou avançar etapa.
