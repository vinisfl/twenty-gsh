...
export const EVENT_PROCESS_STAGE_OPTIONS = [
  ...
  { id: 'a4d9aa3e-ba0f-48bd-b0b8-db2b7d06201e', value: EVENT_PROCESS_STAGE.PRODUCTION_FORMALIZATION_EVENT, label: '5. Produção, formalização e evento', position: 4, color: 'orange' as const },
