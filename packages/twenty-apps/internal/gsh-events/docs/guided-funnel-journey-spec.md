...
- Tarefa automática: **"Enviar contato inicial"**, vencendo no próximo dia útil, atribuída ao dono do deal. Cria só a tarefa da etapa em que o deal nasceu — não gera tarefas retroativas das etapas puladas quando criado avançado. "Concluir" sem nenhum anexo na tarefa abre um mini-formulário (mesmo padrão dos outros do widget "Status agora") para anexar o arquivo ali mesmo; ao confirmar, faz o upload, cria o Attachment vinculado à Task e marca a tarefa como concluída num único passo (issue #73).
